  ...
  return (
    <div className="h-64 bg-gray-800 border-t border-gray-700 p-4 flex flex-col">
      ...
      <div className="flex-1 bg-gray-900 rounded-lg p-2 border border-gray-700 overflow-x-auto relative">
        ...
        <div className="h-12 bg-blue-900/40 border border-blue-500/50 rounded mb-2 p-1 text-xs flex items-center justify-between px-3">
          <span>🎬 Video Track 1</span>
          <span className="text-gray-400">00:00 - 00:10</span>
        </div>
        <div className="h-12 bg-green-900/40 border border-green-500/50 rounded p-1 text-xs flex items-center justify-between px-3">
